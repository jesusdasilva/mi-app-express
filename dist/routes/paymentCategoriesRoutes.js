...
router.post("/payment_categories", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get("/payment_categories/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put("/payment_categories/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.delete("/payment_categories/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
